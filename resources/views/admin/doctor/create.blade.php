             ...
             <form class="forms-sample">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                      ...
                      <input type="text" name="adress" class="form-control" placeholder="Doctor Address">
                   ...
                   <div class="form-group">
                     <label>Image</label>
                      ...
                      <div class="input-group col-xs-6">
                         <input type="text" class="form-control file-upload-info" placeholder="Upload Image" name="image">
