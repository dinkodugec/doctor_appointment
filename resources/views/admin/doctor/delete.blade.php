...
<div class="row justify-content-center">
    <div class="col-lg-12">
         @if(Session::has('message'))
              ...
              @endif
        <div class="card">
             <div class="card-header"><h3>Cofirm Delete</h3></div>
             <div class="card-body">
              <!--  <img src="{{asset('images')}}/{{$user->image}}" width="120"> -->
               <h2></h2>  <!-- ovdje se moze staviti $user->name unutar h2 -->
           ...
           <div class="card-footer">
                <button type="submit" class="btn btn-danger mr-2">Confirm</button>
                 <a href="{{route('doctor.index')}}" class="btn btn-secondary">Cancel</button></a>
            </div>
             </form>
        </div>
    </div>
