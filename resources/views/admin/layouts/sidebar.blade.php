                            ...
                            <nav id="main-menu-navigation" class="navigation-main">
                              ...
                              <!--   <div class="nav-item">
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content"><a href="{{route('doctor.create')}}" class="menu-item">
                                        Create</a>
                                ...
                                <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Appointment Time</span> <span class="badge badge-danger">150+</span></a>
                                    <div class="submenu-content"><a href="{{route('appointment.create')}}" class="menu-item">
                                        Create</a>
                                    ...
                                    <div class="submenu-content"><a href="{{route('patient')}}" class="menu-item">Today appointment</a>
                                        <a href="{{route('appointment.index')}}" class="menu-item">Check</a>
