...
<div class="container">
  ...
  <form action="{{route('appointment.check')}}" method="post">
   ...
   <div class="card">
    ...
    <div class="card-body">
    <input type="text" class="form-control datetimepicker-input" id="datepicker" data-toggle="datetimepicker" data-target="#datepicker" name="date"><br>
